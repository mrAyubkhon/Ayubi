...
import webbrowser  # Импортируем библиотеку для открытия веб-страниц
from telebot import types

# Создаём объект бота с использованием токена
bot = telebot.TeleBot('7365761529:AAFYeDS9e4uWiTk9xBxDebdfs0XEX1BOcPg')
...
# Обработчик кнопки "Time Table website"
...
# Обработчики для дней недели и Gym
...
# Запускаем бота для постоянного прослушивания сообщений
